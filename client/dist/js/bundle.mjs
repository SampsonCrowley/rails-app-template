...
var css = ".header_headerWrapper__2q2Et {\n  font-family: -apple-system, BlinkMacSystemFont, avenir next, avenir, helvetica neue, helvetica, ubuntu, roboto, noto, segoe ui, arial, sans-serif;\n}\n.header_headerWrapper__2q2Et .header_bBox__DwTiG {\n  box-sizing: border-box;\n}\n.header_headerWrapper__2q2Et .header_link__2zJJT {\n  text-decoration: none;\n  transition: color 0.15s ease-in;\n}\n.header_headerWrapper__2q2Et .header_grow__1hWlD {\n  -moz-osx-font-smoothing: grayscale;\n  backface-visibility: hidden;\n  transform: translateZ(0);\n  transition: transform 0.25s ease-in-out;\n}\n.header_headerWrapper__2q2Et .header_grow__1hWlD:hover,\n.header_headerWrapper__2q2Et .header_grow__1hWlD:focus {\n  transform: scale(1.2);\n}\n.header_headerWrapper__2q2Et .header_grow__1hWlD:active {\n  transform: scale(0.95);\n}\n.header_headerWrapper__2q2Et .header_tCenter__1Qt5x {\n  text-align: center;\n}\n.header_headerWrapper__2q2Et .header_tRight__11Yaf {\n  text-align: right;\n}\n.header_headerWrapper__2q2Et .header_white__3qPyi {\n  color: #eee;\n}\n.header_headerWrapper__2q2Et .header_menuLink__3QUXc {\n  display: none;\n  padding: 0.5rem 1rem;\n  text-decoration: none;\n  color: rgba(255,255,255,0.7);\n}\n.header_headerWrapper__2q2Et .header_menuLink__3QUXc:hover {\n  color: #eee;\n}\n@media screen and (min-width: 30em) {\n  .header_headerWrapper__2q2Et .header_menuLink__3QUXc {\n    display: inline-block;\n  }\n}\n.header_headerWrapper__2q2Et .header_vMid__3kddv {\n  vertical-align: middle;\n}\n.header_headerWrapper__2q2Et .header_dt__1cSwZ {\n  display: table;\n}\n.header_headerWrapper__2q2Et .header_dt__1cSwZ .header_dtc__1Fh6L {\n  display: table-cell;\n  padding: 1rem;\n}\n.header_headerWrapper__2q2Et .header_w4__2-wvk {\n  width: 4rem;\n}\n.header_headerWrapper__2q2Et .header_h4__1vAmu {\n  height: 4rem;\n}\n.header_headerWrapper__2q2Et .header_p1__dE77E {\n  padding: 0.25rem;\n}\n.header_headerWrapper__2q2Et .header_dib__2yTGO {\n  display: inline-block;\n}\n.header_headerWrapper__2q2Et .header_cover__2D9nl {\n  background-image: url(\"https://cdn.shopify.com/s/files/1/0019/2443/1932/files/29594662_1356057684494560_3642511867537521213_n.jpg?v=1526093937\");\n  background-position: 50%;\n  background-size: cover;\n  background-repeat: no-repeat;\n}\n.header_headerWrapper__2q2Et .header_cover__2D9nl .header_center__3Xes5 {\n  margin-right: auto;\n  margin-left: auto;\n}\n.header_headerWrapper__2q2Et .header_cover__2D9nl .header_content__2ct0g {\n  background-color: rgba(0,0,0,0.8);\n  padding-bottom: 4rem;\n  color: #eee;\n}\n@media screen and (min-width: 30em) and (max-width: 60em) {\n  .header_headerWrapper__2q2Et .header_cover__2D9nl .header_content__2ct0g {\n    padding-bottom: 8rem;\n  }\n}\n@media screen and (min-width: 60em) {\n  .header_headerWrapper__2q2Et .header_cover__2D9nl .header_content__2ct0g {\n    padding-bottom: 16rem;\n  }\n}\n.header_headerWrapper__2q2Et .header_cover__2D9nl .header_content__2ct0g .header_nav__3Vbjv {\n  width: 100%;\n  max-width: 64rem;\n}\n";
var style = { "headerWrapper": "header_headerWrapper__2q2Et", "bBox": "header_bBox__DwTiG", "link": "header_link__2zJJT", "grow": "header_grow__1hWlD", "tCenter": "header_tCenter__1Qt5x", "tRight": "header_tRight__11Yaf", "white": "header_white__3qPyi", "menuLink": "header_menuLink__3QUXc", "vMid": "header_vMid__3kddv", "dt": "header_dt__1cSwZ", "dtc": "header_dtc__1Fh6L", "w4": "header_w4__2-wvk", "h4": "header_h4__1vAmu", "p1": "header_p1__dE77E", "dib": "header_dib__2yTGO", "cover": "header_cover__2D9nl", "center": "header_center__3Xes5", "content": "header_content__2ct0g", "nav": "header_nav__3Vbjv" };
styleInject(css);
...
var Header = {
  view: function view(_ref) {
    var _ref$attrs = _ref.attrs,
        ...
        _ref$attrs$links = _ref$attrs.links,
        links = _ref$attrs$links === undefined ? [] : _ref$attrs$links,
        attrs = objectWithoutProperties(_ref, ["attrs"]);

    console.log(title, links, attrs);
    return mithril(CSS.header.main, [mithril(CSS.header.cover, [mithril(CSS.header.content, [mithril(CSS.header.nav, [mithril(CSS.header.logoCell, [mithril(CSS.header.logoLink, [mithril(CSS.header.logo, [mithril('title', 'skull icon'), mithril('path', { d: 'M16 0 C6 0 2 4 2 14 L2 22 L6 24 L6 30 L26 30 L26 24 L30 22 L30 14 C30 4 26 0 16 0 M9 12 A4.5 4.5 0 0 1 9 21 A4.5 4.5 0 0 1 9 12 M23 12 A4.5 4.5 0 0 1 23 21 A4.5 4.5 0 0 1 23 12' })])])]), mithril(CSS.header.menuCell, links.map(function (link) {
      return mithril(CSS.header.menuLink, {
        href: link.path,
        oncreate: mithril.route.link
      }, link.name);
    }))]), mithril(CSS.header.banner, [mithril(CSS.pageTitle, title || "Header")])])])]);
  }
};
...
var Body = {
  view: function view(_ref) {
    ...
    return mithril(CSS.page, children);
  }
};

var Home = {
  view: function view() {
    return mithril(CSS.page, [mithril('.cf.pa2', [mithril('.fl.w-100.w-50-ns.ph2', [mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="image/beast_mode.jpg"].db.w-100')]), mithril('a[href="#"].no-underline.pv2.grow.db', [mithril('img[src="image/rockin.jpg"].db.w-100')]), mithril('a[href="#"].no-underline.pv2.grow.db', [mithril('img[src="image/eye_candy.jpg"].db.w-100')]), mithril('a[href="#"].pv2 grow db no-underline black', [mithril('img[src="image/fly.jpg"].db.w-100')])]), mithril('.fl.w-50.w-25-ns.ph2', [mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="image/rockin.jpg"].db.w-100')]), mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="image/fly.jpg"].db.w-100')]), mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="image/eye_candy.jpg"].db.w-100')]), mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="image/fly.jpg"].db.w-100')]), mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="image/rockin.jpg"].db.w-100')]), mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="image/eye_candy.jpg"].db.w-100')]), mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="image/flex.jpg"].db.w-100')]), mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="image/fly.jpg"].db.w-100')])]), mithril('.fl.w-50.w-25-ns.ph2', [mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="image/flex.jpg"].db.w-100')]), mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="image/eye_candy.jpg"].db.w-100')]), mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="image/fly.jpg"].db.w-100')]), mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="https://s3-us-west-2.amazonaws.com/prnt/cc-shanee_960.jpg"].db.w-100')]), mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="https://s3-us-west-2.amazonaws.com/prnt/ZachHurd-190111s_960.jpg"].db.w-100')]), mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="https://s3-us-west-2.amazonaws.com/prnt/hw170211pie-cargo_960.jpg"].db.w-100')]), mithril('a[href="#"].pv2.grow.db.no-underline.black', [mithril('img[src="https://s3-us-west-2.amazonaws.com/prnt/adam-stern-191110_960.jpg"].db.w-100')])])])]);
  }
};

var Page = {
  view: function view() {
    return mithril(CSS.page, [mithril(CSS.pageTitle, "Test Navigation")]);
  }
};
...
var Index = {
  view: function view(_ref) {
    ...
    return mithril('main', [mithril(Header, _extends({ links: LINKS }, attrs))], mithril(Body, children));
  }
};

mithril.route.prefix("#");
var mountNode = document.querySelector("#app-body");
var routes = {};
LINKS.forEach(function (link) {
  return routes[link.path] = {
    render: function render() {
      return mithril(Index, { title: link.name }, mithril(link.module));
    }
  };
});
